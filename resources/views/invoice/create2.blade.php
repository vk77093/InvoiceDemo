    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="{{ route('invoice2.store') }}" method="post">
                @csrf
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row clearfix" style="margin-top:20px">
                            <div class="col-md-12">
                                <div class="float-left col-md-6">
                                  Choose customer:
                                  <br />
                                  <select name="invoice[customer_id]" class="form-control">
                                    ...
                                    <table class="table table-bordered table-hover" id="tab_logic_total">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><div class="input-group mb-2 mb-sm-0">
                                                    <input type="number" name='invoice[tax_percentage]' class="form-control" id="tax" placeholder="0">
